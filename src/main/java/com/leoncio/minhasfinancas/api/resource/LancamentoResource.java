...
import com.leoncio.minhasfinancas.api.dto.AtualizaStatusDTO;
import com.leoncio.minhasfinancas.api.dto.LancamentoDTO;
	...
	public ResponseEntity atualizarStatus(@PathVariable("id")Long id, @RequestBody AtualizaStatusDTO dto) {
		return service.obterPorId(id).map(entity -> {
			...
			if (statusSelecionado == null ) {
				return ResponseEntity.badRequest().body("Não fopi possível atializar o status do lançamento, envie um status válido.");
			} 
			try {
